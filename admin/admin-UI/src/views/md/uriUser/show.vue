...
<template>
  <el-dialog :title="$t('domain.def.show')+'——'+$t('domain.uriUser.pageTitle')" :visible.sync="config.sVisible" :append-to-body="config.appendToBody" width="80%" class="show-dialog" :close-on-click-modal="false" @open="openDialog">
          ...
          <el-row :gutter="10" align="middle" class="show-row">
            ...
            <el-col :md="12" :sm="12" :xs="24" min-width="400px" class="grid-cell">
              <el-form-item :label="'fromTo'|i18n('uriUser')">
                <span>{{ temp.fromTo | fmatEnum(enumClasses['com.easecurity.core.basis.au.UriUserEnum$FromTo']) }}</span>
              </el-form-item>
            </el-col>

            <el-col :md="12" :sm="12" :xs="24" min-width="400px" class="grid-cell">
              <el-form-item :label="'status'|i18n('uriUser')">
                <span>{{ temp.status | fmatEnum(enumClasses['com.easecurity.core.basis.au.UriUserEnum$Status']) }}</span>
              </el-form-item>
            </el-col>

            <el-col :md="12" :sm="12" :xs="24" min-width="400px" class="grid-cell">
              <el-form-item :label="'uri'|i18n('uriUser')">
