...
<html>
    ...
    <body>
        <g:render template="/themes/menuAll" model="['openMenu':'Users', 'activeMenu':'UserList']"/>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <g:message code="user.list.label" args="[]" default="Users" />
			...
			<li><g:message code="users.label" default="Users" /></li>
                </ol>
            </section>
            <!-- 内容头部 /-->
	    ...
	    <!-- 信息提示栏 /-->
            ...
            <section class="content">
                        ...
                        <div class="box-group" id="accordion">
                            <!-- 搜索条件面板 -->
                            <g:form name="search" controller="user" action="index" method="PUT" class="form-horizontal">
                                            ...
                                            <div class="col-sm-11 pull-left">
                                                <div class="form-group col-sm-6">
                                                    <label class="col-sm-3 control-label"><div class="pull-right">
                                                        <g:message code="com.easecurity.admin.core.b.User.name" default="Name" /></div></label>
                                                ...
                                                <div class="form-group col-sm-6">
                                                    <label class="col-sm-3 control-label"><div class="pull-right">
                                                        <g:message code="com.easecurity.admin.core.b.User.code" default="Code" /></div></label>
                                                    <div class="col-sm-9 left"><div class="col-lg-pull-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools pull-right">
                                        <div class="form-group form-inline">
                                            <div class="btn-group">
                                                <g:form name="userDelete" controller="user" action="delete" method="DELETE">
                                                    ...
                                                    <g:link class="btn btn-default" controller="user">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="table-box">
                                        <!--数据列表-->
                                        <f:table collection="${userList}" except="id" />
                                        <!--数据列表/-->
                                    </div>
                                    <!-- 数据表格 /-->
                                </div>
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="box-tools pull-right">
                                        <ul class="pagination">
                                            <s:paginate total="${userCount ?: 0}" mapping='["onclick":"return \$g.searchListByLnk(this)"]'/>
                                        </ul>
                                    </div>
