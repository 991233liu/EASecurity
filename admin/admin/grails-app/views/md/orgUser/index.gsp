	    ...
	    <!-- 信息提示栏 /-->
            ...
            <section class="content">
                        ...
                        <div class="box-group" id="accordion">
                            <!-- 搜索条件面板 -->
                            <g:form name="search" controller="orgUser" action="index" method="PUT" class="form-horizontal">
                                            ...
                                            <div class="col-sm-11 pull-left">
                                                <div class="form-group col-sm-6">
                                                    <label class="col-sm-3 control-label"><div class="pull-right">
                                                        <g:message code="com.easecurity.admin.core.b.OrgUser.name" default="Name" /></div></label>
                                                ...
                                                <div class="form-group col-sm-6">
                                                    <label class="col-sm-3 control-label"><div class="pull-right">
                                                        <g:message code="com.easecurity.admin.core.b.OrgUser.code" default="Code" /></div></label>
                                                    <div class="col-sm-9 left"><div class="col-lg-pull-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="box-tools pull-right">
                                        <ul class="pagination">
                                            <s:paginate total="${orgUserCount ?: 0}" mapping='["onclick":"return \$g.searchListByLnk(this)"]'/>
                                        </ul>
                                    </div>
