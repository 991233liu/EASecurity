        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><g:link controller="org">
                        <g:message code="orgs.label" default="Orgs" />
                    </g:link></li>
                    <li class="breadcrumb-item active"><g:message
                            code="org.label" default="Org" /></li>
                </ol>
            </section>
            <!-- 内容头部 /-->

            <!--信息提示栏-->
            <g:if test="${flash.message || this.org.hasErrors()}"><div class="pad margin no-print">
            ...
            <!-- 正文区域 -->
            <section class="content"><g:form resource="${this.org}" method="POST">
