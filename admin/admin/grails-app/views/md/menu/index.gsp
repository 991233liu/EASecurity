	    ...
	    <!-- 信息提示栏 /-->
            ...
            <section class="content">
                        ...
                        <div class="box-group" id="accordion">
                            <!-- 搜索条件面板 -->
                            <g:form name="search" controller="menu" action="index" method="PUT" class="form-horizontal">
                                    ...
                                    <div class="box-body">
                                        <div class="table-box">
                                            <div class="col-sm-11 pull-left">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    <label class="col-sm-3 control-label"><div class="pull-right">状态</div></label>
                                                    <div class="col-sm-9"><div class="col-lg-pull-12">
                                                        <g:select name="search.status" from="${com.easecurity.core.basis.re.MenuEnum.Status.values()}" noSelection="${['':'']}"
            value="${params.search?.status}"  valueMessagePrefix="com.easecurity.core.basis.re.Menu.status" class="form-control"/>
                                                    </div></div>
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label class="col-sm-3 control-label"><div class="pull-right">
                            ...
                            <div class="box">
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="box-tools pull-right">
                                        <ul class="pagination">
                                            <s:paginate total="${menuCount ?: 0}" mapping='["onclick":"return \$g.searchListByLnk(this)"]'/>
                                        </ul>
                                    </div>
