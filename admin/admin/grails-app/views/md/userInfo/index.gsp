	    ...
	    <!-- 信息提示栏 /-->
            ...
            <section class="content">
                        ...
                        <div class="box-group" id="accordion">
                            <!-- 搜索条件面板 -->
                            <g:form name="search" controller="userInfo" action="index" method="PUT" class="form-horizontal">
                            ...
                            <div class="box">
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="box-tools pull-right">
                                        <ul class="pagination">
                                            <s:paginate total="${userInfoCount ?: 0}" mapping='["onclick":"return \$g.searchListByLnk(this)"]'/>
                                        </ul>
                                    </div>
