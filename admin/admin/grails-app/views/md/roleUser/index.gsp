...
<html>
    ...
    <body>
        <g:render template="/themes/menuAll" model="['openMenu':'RoleUsers', 'activeMenu':'RoleUserList']"/>
        ...
        <div class="content-wrapper">
			...
			<li><g:message code="roleUsers.label" default="RoleUsers" /></li>
                </ol>
            </section>
            <!-- 内容头部 /-->
	    ...
	    <!-- 信息提示栏 /-->
            ...
            <section class="content">
                        ...
                        <div class="box-group" id="accordion">
                            <!-- 搜索条件面板 -->
                            <g:form name="search" controller="roleUser" action="index" method="PUT" class="form-horizontal">
                                            ...
                                            <div class="col-sm-11 pull-left">
                                                <div class="form-group col-sm-6">
                                                    <label class="col-sm-3 control-label"><div class="pull-right">
                                                        <g:message code="com.easecurity.admin.core.r.RoleUser.name" default="Name" /></div></label>
                                                ...
                                                <div class="form-group col-sm-6">
                                                    <label class="col-sm-3 control-label"><div class="pull-right">
                                                        <g:message code="com.easecurity.admin.core.r.RoleUser.code" default="Code" /></div></label>
                                                    <div class="col-sm-9 left"><div class="col-lg-pull-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools pull-right">
                                        <div class="form-group form-inline">
                                            <div class="btn-group">
                                                <g:form name="roleUserDelete" controller="roleUser" action="delete" method="DELETE">
                                                    ...
                                                    <g:link class="btn btn-default" controller="roleUser">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="table-box">
                                        <!--数据列表-->
                                        <f:table collection="${roleUserList}" except="id" />
                                        <!--数据列表/-->
                                    </div>
                                    <!-- 数据表格 /-->
                                </div>
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="box-tools pull-right">
                                        <ul class="pagination">
                                            <s:paginate total="${roleUserCount ?: 0}" mapping='["onclick":"return \$g.searchListByLnk(this)"]'/>
                                        </ul>
                                    </div>
