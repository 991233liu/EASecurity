...
<body class="hold-transition login-page">
	...
	<!-- 加密用盐值，每个系统唯一，需要联系管理员获取 /-->
        ...
        <div class="login-box-body">
            ...
            <form action='/admin/changePassword/changeOwnerPassword' method='POST' id='changePasswordForm' class='cssform' autocomplete='off'>
                <div class="form-group has-feedback">
                    <g:passwordField name="oldPassword" class="form-control"
                                     placeholder="${message(code: 'user.password.label', default: 'OldPassword')}" />
                ...
                <div class="row">
                    <button type="submit" class="btn btn-primary btn-block btn-flat" onclick="return onChangePassword()">
