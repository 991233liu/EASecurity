...
@I18nSource("d:/work/code/oschina/EASecurity/develop/core/easecurity-core-api/src/main/java/com/easecurity/core/basis/b/User.java")
class User extends com.easecurity.core.basis.b.User {
    ...
    static constraints = {
        ...
        acStatus length: 2, nullable: true
        pdStatus length: 2, nullable: true
    ...
    static mapping = {
        table 'b_user'
        id generator: 'uuid'
        acStatus enumType: "identity"
        pdStatus enumType: "identity"
