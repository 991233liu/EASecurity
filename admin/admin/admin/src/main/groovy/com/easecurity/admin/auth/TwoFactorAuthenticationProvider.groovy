...
class TwoFactorAuthenticationProvider extends DaoAuthenticationProvider {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails,
        ...
        if (!(details instanceof TwoFactorAuthenticationDetails)) {
            ...
            throw new BadCaptchaException(messages.getMessage(
                    "AbstractUserDetailsAuthenticationProvider.badCredentials",
                    "Bad credentials"));
        }
        def twoFactorAuthenticationDetails = details as TwoFactorAuthenticationDetails
        System.out.println("-------# 输入的验证码为：" + twoFactorAuthenticationDetails.captcha)
        System.out.println("-------# 输入的验证码key为：" + twoFactorAuthenticationDetails.captchaKey)
        ...
        // TODO 数据库验证
        // TODO Redis验证
        if (!loginCaptchaDisable && (gifCaptcha1 == null || !(gifCaptcha1.validTime > System.currentTimeMillis() && gifCaptcha1.gvalue.equals(twoFactorAuthenticationDetails.captcha.toLowerCase())))) {
