...
class RoleUserControllerSpec extends Specification implements ControllerUnitTest<RoleUserController>, DomainUnitTest<RoleUser> {
    ...
    void "Test that the show action returns the correct model"() {
        ...
        when:"A domain instance is passed to the show action"
            populateValidParams(params)
            def roleUser= new RoleUser(params).save(flush:true)

            controller.show(roleUser.id).get()

        then:"A model is populated containing the domain instance"
            model.roleUser.id==roleUser.id
    }
    ...
    void "Test that the edit action returns the correct model"() {
        ...
        when:"A domain instance is passed to the edit action"
            populateValidParams(params)
            def roleUser = new RoleUser(params).save(flush:true)
            controller.edit(roleUser?.id).get()
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        when:"An invalid domain instance is passed to the update action"
            ...
            controller.update(roleUser.id).get()
    ...
    void "Test that the delete action deletes an instance if it exists"() {
        ...
        when:"The domain instance is passed to the delete action"
            controller.delete(roleUser.id).get()
